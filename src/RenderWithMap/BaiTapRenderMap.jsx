    ...
    return (
      <div className="content">
        <nav
          ...
          style={{ backgroundColor: "rgb(79 78 137 / 79%)" }}
        >
                ...
                <div className="col-3 mt-2" key={index}>
                  <div className="card">
                    ...
                    <div className="card-body bg-dark text-white">
                      <h4 style={{ height: 75 }}>{prod.tenPhim}</h4>
                      <p style={{height: 100, fontSize:15}} > {prod.moTa.length > 100 ? prod.moTa.substr(0, 100) + '...' : prod.moTa}</p>
                    </div>
                  </div>
                </div>
              );
