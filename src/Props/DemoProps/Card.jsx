...
export default class Card extends Component {
  render() {
    /**
        ...
        + state làm nhiệm vụ quản lý các giá trị thay đổi trên giao diện và có thể gán lại gia trị mới thông qua hàm setState
        + props làm nhiệm vụ nhận giá trị từ nói sử dụng thẻ (component cha) truyền vào và không được gán lại (readonly);
